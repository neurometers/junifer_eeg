"""Generalization decoding marker for junifer_eeg."""
...
class GeneralizationDecoding(BaseMarker):
    """Generalization decoding marker using MNE-Python's GeneralizingEstimator.

    This marker performs temporal generalization decoding analysis by creating
    epochs from continuous data and computing cross-temporal decoding matrices.
    ...
    def __init__(
        ...
        """Initialize the GeneralizationDecoding marker.
    ...
    def compute(
        ...
        -------
        dict
            Computed generalization decoding matrix.
        """
        ...
        # Create GeneralizingEstimator
        time_gen = GeneralizingEstimator(clf, scoring=self.scoring, n_jobs=1)
        ...
        try:
            ...
            n_times = X.shape[2]
            mean_scores = np.zeros((n_times, n_times))
